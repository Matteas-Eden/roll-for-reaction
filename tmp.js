        ...
        <div className={style.stylingParent}>
            <div className={style.bookingDetailsContainer}>
                ...
                {hideTimes ? null : (
                    ...
                    >
                        {isLoading ? (
                            ...
                            <>
                                {noTimes ||
                                availableTimes.availableHours == null ? (
                                    <div>Closed</div>
                                ) : (
                                    generateAllTimes(openTime, closeTime).map(
                                        time => {
                                            const available =
                                            ...
                                            return (
                                                // Hey Kim, this is the part related to the clickable button
                                                <Button
                ...
                <div className={style.submitButtonContainer}>
                    {/* This too,Kim, because the disabled property renders the button unclickable if true */}
                    <Button
                        ...
                        disabled={
                            seats.length === 0 || selectedTime.length === 0
                        }
                    >
...
const mapDispatchToProps = dispatch => ({
    ...
    onSeatChange: seats => {
        dispatch(addBookingSeats(seats));
    },
    onDateChange: date => {
